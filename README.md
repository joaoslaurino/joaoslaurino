...
<p align="center">
  <a href="https://www.linkedin.com/in/jo%C3%A3o-vitor-laurino-5b249a165/">
    <img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn">
  </a>
  <a href="https://github.com/joaoslaurino?tab=repositories">
...
| | Project | Stack |
| :---: | :--- | :--- |
| 👁️ | **[eyewave](https://github.com/joaoslaurino/eyewave)** — simulator of ocular aberrations and the point spread function: Zernike wavefronts, Fourier optics, real-time PSF and MTF. | `Fourier optics` |
| 🔍 | **[lasik-reality](https://github.com/joaoslaurino/lasik-reality)** — evidence-based site exposing the reality of refractive surgery and fighting misinformation. | `TypeScript` `React` |
| ⚙️ | **[compiler-jac](https://github.com/joaoslaurino/compiler-jac)** — a full compiler front-to-back: lexer, parser, semantic analysis and JVM bytecode generation. | `Java` `Python` `ANTLR` |
| 📊 | **[tracing-openmp](https://github.com/joaoslaurino/tracing-openmp)** — HPC research on tracing support for OpenMP task-based applications. | `C` `OpenMP` `R` |
